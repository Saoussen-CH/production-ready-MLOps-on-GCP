...
REPO_NAME="pipelineimages"
IMAGE_NAME="taxifare_training_container"
IMAGE_TAG="v3"
IMAGE_URI=f"us-central1-docker.pkg.dev/{PROJECT_ID}/{REPO_NAME}/{IMAGE_NAME}:{IMAGE_TAG}"
...
def pipeline(
    ...
    training_args_step = get_training_args_dict_op(**args).set_display_name("Get-Training-Args")
...
if __name__ == "__main__":
    compiler.Compiler().compile(
        ...
        package_path='taxifare-pipeline.yaml')